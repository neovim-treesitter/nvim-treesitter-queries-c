...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-c/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-c/actions/workflows/validate.yml)

Neovim tree-sitter queries for **c**, part of the
...
- [ ] Changes are scoped to `c` — do not include files for other languages
